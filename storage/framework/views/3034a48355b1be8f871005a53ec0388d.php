...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.error','data' => ['title' => 'Data tidak dapat diproses','code' => '422','message' => 'Periksa kembali data yang dikirim dan coba lagi.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Data tidak dapat diproses','code' => '422','message' => 'Periksa kembali data yang dikirim dan coba lagi.']); ?>
    <a class="btn btn-primary" href="<?php echo e(url()->previous() === url()->current() ? route('home') : url()->previous()); ?>">Periksa kembali</a>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/errors/422.blade.php ENDPATH**/ ?>