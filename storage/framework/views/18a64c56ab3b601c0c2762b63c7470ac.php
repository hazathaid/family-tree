...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.navigation.top','data' => ['variant' => 'guest']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    <main id="main-content" class="container py-4 py-md-5">
        <div class="mx-auto" style="max-width: 32rem"><?php echo e($slot); ?></div>
    </main>
