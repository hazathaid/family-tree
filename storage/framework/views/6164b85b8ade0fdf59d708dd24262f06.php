...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.error','data' => ['title' => 'Halaman tidak ditemukan','code' => '404','message' => 'Alamat yang Anda buka tidak tersedia atau sudah dipindahkan.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Halaman tidak ditemukan','code' => '404','message' => 'Alamat yang Anda buka tidak tersedia atau sudah dipindahkan.']); ?>
