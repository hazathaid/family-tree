...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.error','data' => ['title' => 'Terjadi gangguan','code' => '500','message' => 'Sistem sedang mengalami kendala. Silakan coba kembali beberapa saat lagi.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Terjadi gangguan','code' => '500','message' => 'Sistem sedang mengalami kendala. Silakan coba kembali beberapa saat lagi.']); ?>
