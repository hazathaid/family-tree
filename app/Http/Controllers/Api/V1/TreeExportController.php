...
{
    public function __construct(private readonly TreePresentationService $trees, private readonly TreePngExportService $png, private readonly TreePdfExportService $pdf) {}
    ...
    private function download(ExportTreeRequest $request, string $format): Response
    {
        ...
        $tree = $this->trees->present($root, $request->string('mode', 'full')->toString(), $request->integer('depth', 5), $request->string('layout', 'vertical')->toString());
